<?php require_once('connection.php');
	...
	$NoOfRooms=$_POST['txtRoomAmount'];// no of rooms
		...
		$query="insert into bookings (fName,lName,email,checkInDate,chekOutDate,telephone,reqs,price,roomType,noRooms,statusPayment) values('$fname','$lname','$email','$checkInDate','$checkOutDate','$telephone','$reqs',$price,'$room','$NoOfRooms','bookedonly')";
	$result=mysqli_query($connection,$query);
